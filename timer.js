(() => {
          ...
          <div class="custom-row">
            <div class="field">
              ...
              <div style="display:flex; gap:6px; align-items:center;">
                ...
                <span style="color:var(--silver-mid); font-family:'Rajdhani'; font-size:14px;">min</span>
  ...
  el.shareBtn.addEventListener('click', () => openPage(el.sharePage));
  el.closeShareBtn.addEventListener('click', () => closePage(el.sharePage));
  ...
  el.settingsBtn.addEventListener('click', () => openPage(el.settingsPage));
  el.closeSettingsBtn.addEventListener('click', () => closePage(el.settingsPage));
  el.viewDisclaimerBtn.addEventListener('click', () => {
    closePage(el.settingsPage);
    openPage(el.disclaimerPage);
  });
  el.closeDisclaimerBtn.addEventListener('click', () => closePage(el.disclaimerPage));
